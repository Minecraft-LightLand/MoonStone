...
public class ironhorseshoe extends EpicItem {
	public ironhorseshoe() {
	...
	public void appendHoverText(ItemStack stack, @javax.annotation.Nullable Level level, List<Component> tooltip, TooltipFlag flags) {
		...
		tooltip.add(Component.translatable("-20% 摔落伤害").withStyle(ChatFormatting.GOLD));
		tooltip.add(Component.translatable("-5% 受到伤害").withStyle(ChatFormatting.GOLD));
	}
}
