...
public class goldbook extends EpicItem {
	public goldbook() {
	...
	public void appendHoverText(ItemStack stack, @javax.annotation.Nullable Level level, List<Component> tooltip, TooltipFlag flags) {
		...
		tooltip.add(Component.translatable("· 猪灵与你保持中立").withStyle(ChatFormatting.GOLD));
		tooltip.add(Component.translatable("· 与猪灵交易是有50%的概率返还一个金锭").withStyle(ChatFormatting.GOLD));
